...
/* מסך סרטון הפתיחה של הפרק.
   ...
   purpose — אופציונלי: { title, text }. כשהוא נמסר, מטרת הפרק פותחת
   את המסך — כותרת, קו זהב והפסקה — והסרטון בא מיד אחריה, באותו רוחב
   עמודה בדיוק, כך שהשניים נקראים כיחידה אחת ולא כשני אזורים. בלעדיו
   המסך נשאר כשהיה — הסרטון הוא כל התוכן. */
