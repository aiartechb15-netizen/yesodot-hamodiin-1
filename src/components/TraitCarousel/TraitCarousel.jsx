 ...
 * חצים, בשבע תחנות ממוספרות ובמקשי החצים במקלדת.
 *
    ...
    >
      <div className="tcar__stage">
        <button className="tcar__arrow" type="button" onClick={prev} aria-label="המאפיין הקודם">
          <Icon name="chevron" size={22} className="tcar__chev tcar__chev--prev" />
        </button>
        ...
        <button className="tcar__arrow" type="button" onClick={next} aria-label="המאפיין הבא">
          <Icon name="chevron" size={22} className="tcar__chev tcar__chev--next" />
        </button>
      </div>

      {/* שבע תחנות ניווט, מימין לשמאל */}
